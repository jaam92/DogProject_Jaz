...
ibdSegs = fread("/u/home/j/jmooney3/klohmueldata/jazlyn_data/DogProject_Jaz/SubsetStronen2013Sites/IBDSeq/MergedFitakCornell_allChroms_Stronen2013SitesHaplotypes_IBDSeq.ibd")
...
for(i in seq_along(splitDF)){
  ...
  filename = paste(breedID, "_IBDSeqIBDSegsStronen2013SitesOnly_allchroms_unrelatedsOnly.ibd",sep = "")
