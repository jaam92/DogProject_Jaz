...
out_dir='/u/flashscratch/j/jmooney3/CaseControl_IBDSegs'
ibdSeq_dir='/u/home/j/jmooney3/klohmueldata/jazlyn_data/software/Phasing_IBD/IBDSeq'

CHROM=${SGE_TASK_ID}

#Files
vcfin=${in_dir}/'MergedFile_CornellCanineFitak_allIndivs_chr'${CHROM}'.vcf'
ibdout=${out_dir}/'MergedFile_CornellCanineFitak_allIndivs_chr'${CHROM}'_Haplotypes_IBDSeq'
