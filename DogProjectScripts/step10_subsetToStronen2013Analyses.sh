...
#for f in {1..38} 
#do
#vcftools --vcf SubsetStronen2013Sites/VCFs/MergedFile_CornellCanineFitak_allIndivs_chr"$f".vcf --chr "$f" --LROH --out SubsetStronen2013Sites/ROH/mergedFile_CornellCanineFitak_StronenSites
#done 
