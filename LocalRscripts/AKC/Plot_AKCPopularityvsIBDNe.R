...
ggplot() + geom_line(data=AKC_popularityTransposed, aes(x=abs(Time-2005),y=golden_retriever)) +geom_line(data=AKC_popularityTransposed, aes(x=abs(Time-2005),y=labrador_retriever, colour="labrador_retriever")) +geom_line(data=AKC_popularityTransposed, aes(x=abs(Time-2005),y=cocker_spaniel, colour="cocker_spaniel")) +geom_line(data=AKC_popularityTransposed, aes(x=abs(Time-2005),y=boxer, colour="boxer")) +geom_line(data=AKC_popularityTransposed, aes(x=abs(Time-2005),y=yorkshire_terrier, colour="yorkshire_terrier")) +geom_line(data=AKC_popularityTransposed, aes(x=abs(Time-2005),y=newfoundland, colour="newfoundland")) +geom_line(data=AKC_popularityTransposed, aes(x=abs(Time-2005),y=german_shepherd_dog, colour="german_shepherd_dog")) +geom_line(data=AKC_popularityTransposed, aes(x=abs(Time-2005),y=maltese, colour="maltese")) +geom_line(data=AKC_popularityTransposed, aes(x=abs(Time-2005),y=poodle, colour="poodle")) +geom_line(data=AKC_popularityTransposed, aes(x=abs(Time-2005),y=rottweiler, colour="rottweiler")) + scale_colour_manual(name="Breed", values=c("blue","red","brown", "green", "pink", "orange", "gray", "black", "purple")) + labs(x="Time(Years Ago)", y="Popularity")
