...
AKC_popularityTransposed = read.delim("~/Documents/DogProject_Jaz/AKC/AKC_breedPopularityTransposed_1926thru2005.txt", check.names = F)

#pdf("~/Documents/DogProject_Jaz/AKC/AKCPopularity_vs_IBDNe.pdf")
