...
option_list <- list( 
  ...
  make_option(c("--outFilePath"), type="character", default="/u/scratch/j/jmooney3/PermuteROH/test/",
...
permuteROH = function(dataFrame){
  totalNonROH = sum(as.numeric(autosome$LENGTH)) - sum(as.numeric(dataFrame$AUTO_LEN))
